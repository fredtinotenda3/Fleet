...
//
// THE CENTRAL RULE THIS TYPE EXISTS TO ENFORCE: nothing in Phase O2
// ever writes a NEW TransportPartner/ContractedVehicle row, and nothing
// ever sets TransportCostSourceRecord.transporterPartnerId/
// contractedVehicleId, except through a confirmed review item. A
// candidate above the similarity floor is still only a SUGGESTION —
// see normalization-matcher.service.ts and
// confirm-review-item.handler.ts.
