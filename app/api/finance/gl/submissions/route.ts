// app/api/finance/gl/submissions/route.ts
...
export const GET = withAuth(
  (req: NextRequest) => glReconciliationController.listSubmissions(req),
  { permission: Permission.FINANCE_VIEW }
);

export const POST = withAuth(
  (req: NextRequest) => glReconciliationController.submit(req),
