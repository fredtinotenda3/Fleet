// frontend/modules/workorders/components/WorkOrderFilterBar.tsx
//
// Named FilterBar (not "WorkOrderFilters") to avoid colliding with the
// WorkOrderFilters *type* re-exported from ../types in the module's
// top-level barrel (frontend/modules/workorders/index.ts) -- a
// wildcard `export *` can't have a type and a value share one name.
...
export function WorkOrderFilterBar({ filters, onChange }: WorkOrderFilterBarProps) {
    ...
    <div className="flex flex-wrap items-end gap-3">
      ...
      <div className="w-44 space-y-1.5">
        ...
        <Select
          ...
          onValueChange={(value) => onChange({ ...filters, status: value === 'all' ? undefined : (value as WorkOrderFilters['status']) })}
        >
      ...
      <div className="w-40 space-y-1.5">
        ...
        <Select
          ...
          onValueChange={(value) => onChange({ ...filters, priority: value === 'all' ? undefined : (value as WorkOrderFilters['priority']) })}
        >
